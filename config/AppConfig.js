...
export class AppConfig {
    constructor() {
        ...
        this.kubernetesNamespace = process.env['KUBERNETES_IMAGE_REPO'];
        ...
        this.webexDomain = process.env['WEBEX_DOMAIN'];
        this.webexMessagePath = process.env['WEBEX_MESSAGE_PATH'];
    }
}

// https://great-sloth-86.loca.lt
